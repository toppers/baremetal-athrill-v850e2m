...
| `c`                           | `INFO: INITIALIZE POINTER`<br>`global_value = 0x12345678`               |
|                               | `global_value address = 0x05FF7408`                                    |
| `cpu`                         | `PC: 0xac6`<br>`R10: 0x0`<br>`R11: 0xc39`                              |
| `n` (`mov 0x5ff7404, r10`)    | `PC: 0xacc`<br>`R10: 0x5ff7404 (global_value_pointer)`                  |
| `n` (`ld.w 0[r10], r10`)      | `PC: 0xad0`<br>`R10: 0x5ff7408 (global_value)`                         |
| `n` (`ld.w 0[r10], r10`)      | `PC: 0xad4`<br>`R10: 0x87654321`                                       |
| `n` (`st.w r10, 0[r29]`)      | `PC: 0xad8`<br>`Stack: 0x87654321 written`                             |
...
| `st.w r10, 0[r29]`         | `0x87654321`           | `0xc39`                |
